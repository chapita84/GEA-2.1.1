...
// ✅ Se importan los componentes de la tabla
import {
  Table,
  TableBody,
  TableCell,
...
export default function AdminComerciosVerdes() {
  ...
  useEffect(() => {
    const fetchComercios = async () => {
      try {
        ...
        console.error(err);
        setError('Error al cargar los comercios. Por favor, intente de nuevo.');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!currentComercio || !currentComercio.address) {
    ...
    try {
      ...
      const comercioData: Omit<ComercioVerde, 'location'> = {
      ...
      console.error(err);
      setError('Error al guardar el comercio. Verifique la dirección e intente de nuevo.');
    }
  };
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* ✅ Se reemplaza la cuadrícula de tarjetas por una tabla */}
      <Card>
